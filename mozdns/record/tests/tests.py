...
class INTRV4RecordTests(BaseRecordTestCase, TestCase):
    ...
    def setUp(self):
        ...
        super(INTRV4RecordTests, self).setUp()

    def post_data(self):
        return {
            'description': random_label(),
            'ttl': random_byte(),
            'fqdn': 'intr' + random_label() + "." + self.domain.name,
...
class INTRV6RecordTests(BaseRecordTestCase, TestCase):
    test_type = StaticInterface
    ...
    def setUp(self):
        ...
        super(INTRV6RecordTests, self).setUp()
