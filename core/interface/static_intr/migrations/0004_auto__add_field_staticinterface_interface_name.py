...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StaticInterface.interface_name'
        db.add_column('static_interface', 'interface_name',
                      self.gf('django.db.models.fields.CharField')(default='eth0', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StaticInterface.interface_name'
        db.delete_column('static_interface', 'interface_name')
    ...
    models = {
        ...
        'soa.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1362291757'}),
        ...
        'static_intr.staticinterface': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interface_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        'static_intr.staticintrkeyvalue': {
            'Meta': {'unique_together': "(('key', 'value', 'obj'),)", 'object_name': 'StaticIntrKeyValue', 'db_table': "'static_inter_key_value'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'obj': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'keyvalue_set'", 'to': "orm['static_intr.StaticInterface']"}),
